              ...
              <tr key={e.id}>
                ...
                <td>
                  ...
                  {(e.estudiantes || []).some((s) => s.apto_rendir === false) && (
                    <><br /><span className="chip rojo">no rinde: {(e.estudiantes || []).filter((s) => s.apto_rendir === false).length}</span></>
                  )}
                </td>
      ...
      <div className="card" style={{ marginTop: 12 }}>
        ...
        {noHabilitados.length > 0 && (
          <div className="aviso warn">
            ...
            {noHabilitados.map((s) => s.nombre).join(', ')}. No aparecen en la rúbrica ni en el
            acta porque no están habilitados/as para rendir. Si esto cambió, coordinación debe
            actualizarlo antes de cerrar el examen.
          </div>
        )}
      </div>
