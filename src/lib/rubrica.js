      ...
      criterios: [
        {
          ...
          mejora:
            'Explicitar y justificar las decisiones teóricas y metodológicas del proceso investigativo, reconociendo sus alcances, sus limitaciones y los criterios disciplinares que las sustentan.',
        },
        {
          id: 'p_coh',
          ...
          mejora:
            'Articular lógicamente introducción, metodología, resultados y discusión, de modo que la presentación evidencie un proceso investigativo coherente, sin contradicciones ni vacíos relevantes.',
        },
      ],
    },
    individual: {
      ...
      criterios: [
        {
          ...
          mejora:
            'Emplear el lenguaje técnico de la disciplina con precisión conceptual y en coherencia con el marco de la investigación, evitando términos genéricos o imprecisos.',
        },
        {
          id: 'p_clar',
          ...
          mejora:
            'Exponer con claridad, orden lógico y fluidez argumentativa, ajustándose al tiempo asignado.',
        },
      ],
    },
  },
      ...
      criterios: [
        {
          ...
          mejora:
            'Reflexionar de manera crítica e integrada sobre las decisiones del proceso investigativo, analizando sus implicancias éticas y profesionales y vinculando los hallazgos con el rol del psicólogo/a.',
        },
        {
          id: 'd_proy',
          ...
          mejora:
            'Proyectar los hallazgos hacia la práctica profesional de forma situada y viable, incorporando una valoración pertinente de la interdisciplinariedad cuando el problema lo requiera.',
        },
      ],
    },
    transversales: {
      ...
      criterios: [
        {
          ...
          mejora:
            'Participar activamente en el diálogo profesional, argumentando con coherencia, usando lenguaje técnico preciso y respondiendo de manera consistente con lo presentado en la investigación.',
        },
        {
          id: 'd_form',
          ...
          mejora:
            'Comunicarse con claridad, orden lógico y formalidad académica, manteniendo una actitud profesional durante toda la defensa y reconociendo las limitaciones con honestidad académica.',
        },
      ],
    },
  },
...
// Devuelve el texto de mejora de un criterio, buscándolo en toda la rúbrica.
export const TODOS_CRITERIOS = [
  ...RUBRICA.presentacion.grupal.criterios,
  ...RUBRICA.presentacion.individual.criterios,
  ...RUBRICA.defensa.disciplinares.criterios,
  ...RUBRICA.defensa.transversales.criterios,
]

export const criterioPorId = (id) => TODOS_CRITERIOS.find((c) => c.id === id)
